...
#logging
logger = logging.getLogger('DP PPTOD')
...
if __name__ == '__main__':
    ...
    for epoch in range(args.epoch_num):
        ...
        with torch.no_grad():
            ...
            dev_batch_list = data.build_all_evaluation_batch_list(ref_db, input_contain_db, eva_batch_size=args.number_of_gpu * args.batch_size_per_gpu, eva_mode='dev')
            ...
            p.finish()
            ####################################
            metric_result = evaluator.run_metrics(all_dev_result)
            ...
            if dev_f1 > max_dev_f1:
                ...
                print ('-----------------------------------')
                # --------------------------------------------------------------------------------------------- #
            print ('Current f1 is {}, best f1 is {}'.format(round(dev_f1, 2), round(max_dev_f1, 2)))
